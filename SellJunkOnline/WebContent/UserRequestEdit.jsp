	...
	<body>
		...
		<div class='sell-junk-user-add-request-wrapper dflex'>
			...
			<%
				...
				String sql = "select * from userpickuprequest where id=?";
			...
			<section>
				<div class="sell-junk-add-request-form-wrapper">
					<h1 class="M0 text-center">Edit Your PickUp Request</h1>
					<form class="sell-junk-add-request-form" action="UserRequestEdit?id=<%=request.getParameter("id")%>" method="post">
						<div class="form-label-input-container">
							<div class="address-block">
								...
								<div class="dflex-align-item-center" id="AddressBlockViewMode">
									<span class="address-val"><%=rs1.getString("Address") %> <%=rs1.getString("City") %> <%=rs1.getString("State") %></span>
									
									<input type="hidden" value="<%=rs1.getString("Address") %>" name="Address1" id="Address1"> 
									<input type="hidden" value="<%=rs1.getString("State") %>" name="State1" id="State1">
									<input type="hidden" value="<%=rs1.getString("City") %>" name="City1" id="City1">
								</div>
						
								<div id="AddressBlockEditMode" style="display: none;">
									<div class="dflex-align-item-center">
										<label class="form-label">Street</label>
										<input type="text" value="<%=rs1.getString("Address") %>" name="Address" id="Address" class="form-control" placeholder="Street">
									</div>
							...
							<div class="dflex-align-item-center">
								...
								<div class="calendar-input-container">
									<input id=datepicker name="PickUpDate" type="text" autocomplete="off" placeholder="YY/MM/DD" value="<%=rs1.getDate("PickUpDate") %>" class="form-control" readonly required/> 
								</div>
							</div>
						...
						<div class="sell-junk-add-request-form-action-wrapper dflex-justify-content-center">
							<input type="submit" value="Edit Request" class="btn btn-normal btn-ok">
					   	</div>
					</form>
				</div>
			</section>	
